...
filename='teststand_2_config.yaml' #changeable by parser (later)
...
#datadir = "/Users/patricksieberer/dummy/hgcaldata/2018/Hexaboard_V3_ReceptionTests/"

def run_test():
    os.system("rm yamlConfigOutput data IV_LOG")
    os.system("mkdir -p " + str(glb_options['outputCommonPath']) + "module"+str(glb_options['moduleNumber'])+'/raw')
    os.system("mkdir -p " + str(glb_options['outputCommonPath']) + "module"+str(glb_options['moduleNumber'])+'/yaml')
    os.system("mkdir -p " + str(glb_options['outputCommonPath']) + "module"+str(glb_options['moduleNumber'])+'/iv')
    '''os.system("ln -s -F " + datadir + "module"+str(glb_options['moduleNumber'])+'/raw'+" data2")
    os.system("ln -s -F " + datadir + "module"+str(glb_options['moduleNumber'])+'/yaml'+" yamlConfigOutput2")
    os.system("ln -s -F " + datadir + "module"+str(glb_options['moduleNumber'])+'/iv'+" IV_LOG2")'''
    """print('AFTER:')
